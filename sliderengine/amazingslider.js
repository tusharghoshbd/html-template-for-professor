...
(function($) {
    $.fn.asHTML5VideoControls = function(skinFolder, parentInst, hidecontrols, hideplaybutton, defaultvolume) {
        ...
        if (!isIPhone && ($videoObj.get(0).requestFullscreen || $videoObj.get(0).webkitRequestFullScreen || $videoObj.get(0).mozRequestFullScreen || $videoObj.get(0).webkitEnterFullScreen || $videoObj.get(0).msRequestFullscreen)) {
            ...
            document.addEventListener("MSFullscreenChange", function() { isFullscreen = document.msFullscreenElement != null;
...
(function($) {
    $.fn.ashtml5lightbox = function(options) {
        ...
        inst.createMarkup = function() {
            ...
            if (inst.options.titlestyle == "right" || inst.options.titlestyle == "left") {
                ...
                if (inst.options.titlestyle == "right") { inst.$elemWrap.css({ position: "relative", "float": "left" });
                    inst.$elemData.css({ position: "relative", overflow: "hidden", padding: inst.options.bordersize + "px" }) } else {
                    inst.$elemWrap.css({
                        position: "relative",
                        overflow: "hidden"
                    });
            ...
            } else if (inst.options.titlestyle == "inside") { inst.$elemData.css({ position: "absolute", margin: inst.options.bordersize + "px", bottom: 0, left: 0, "background-color": "#333", "background-color": "rgba(51, 51, 51, 0.6)" });
        ...
        inst.hideNavArrows = function() {
            ...
            } else { inst.$next.addClass("html5-hide");
        ...
        inst.loadElem = function(elem) {
            ...
            switch (elem[ELEM_TYPE]) {
                case 0:
                    var imgLoader = new Image;
                    $(imgLoader).on("load", function() { inst.showImage(elem, imgLoader.width, imgLoader.height) });
        ...
        inst.showYoutubeVimeo = function(elem) {
            ...
            inst.resizeLightbox(dataW, dataH, true, function() {
                ...
                if (inst.options.loopvideo) { href += href.indexOf("?") < 0 ? "?" : "&";
                    switch (elem[ELEM_TYPE]) {
                        case 3:
                ...
                inst.resizeLightbox(dataW, dataH, true, function() {
                    ...
                    if (inst.options.autoresizecontent && inst.isSameDomain(elem[ELEM_HREF])) {
                        ...
                        $("#html5lightbox-web-iframe",
                            inst.$lightbox).on("load", function() { $(this).data("sameoriginloaded", true);
                            inst.resizeWindow() })
                    }
                    if (inst.autosliding) { inst.slideTimeout.stop();
                        inst.slideTimeout.start() }
            ...
            if (inst.options.autoresizecontent && (inst.currentElem[ELEM_TYPE] == 7 || inst.currentElem[ELEM_TYPE] == 10)) {
                ...
                if (resizeHeight) {
                    ...
                    if (inst.options.titlestyle ==
                        "left" || inst.options.titlestyle == "right") inst.$lightboxBox.css({ "height": boxH });
        ...
        inst.embedHTML5Video = function($container,
            ...
            $("video", $container).off("ended").on("ended", function() { $(window).trigger("html5lightbox.videofinished");
                if (inst.autosliding) inst.gotoSlide(-1);
                else if (inst.options.autoclose) inst.finish() })
        };
    ...
    $.fn.amazingslider = function(options) {
        ...
        AmazingSlider.prototype = {
                ...
                $(".amazingslider-slides", this.container).find("li").each(function() {
                    ...
                    if (img.length > 0) {
                        ...
                        for (var i = 0; i < lazytags.length; i++)
                            if (img.data(lazytags[i]) && img.data(lazytags[i]).length > 0) { src = img.data(lazytags[i]);
                                break }
                        var title =
            ...
            initHtml5Lightbox: function() {
                ...
                if (this.lightboxArray.length > 0) {
                    ...
                    this.html5Lightbox.onLightboxClosed = function() {
                        if (instance.lightboxPaused) { instance.lightboxPaused = false;
            ...
            showSocial: function() {
                ...
                if (this.options.socialmode == "mouseover") $(".amazingslider-wrapper-" + this.id, this.container).hover(function() { clearTimeout(instance.socialTimeout);
                    $(".amazingslider-social-" + instance.id, instance.container).fadeIn() }, function() { instance.socialTimeout = setTimeout(function() { $(".amazingslider-social-" + instance.id, instance.container).fadeOut() }, instance.options.arrowhideonmouseleave) });
            ...
            initVideoApi: function() {
                ...
                var initYoutube = false,
                    initVimeo = false;
                for (i = 0; i < this.elemArray.length; i++) { videos = this.elemArray[i][ELEM_VIDEO];
            ...
            createSliderTimeout: function() {
                var instance = this;
                this.sliderTimeout = new ASliderTimer(this.options.slideinterval, function() { instance.slideRun(-1) }, this.options.showtimer ? function(percent) { instance.updateTimer(percent) } :
                    null);
                if (instance.options.pauseonmouseover) $(".amazingslider-slider-" + this.id, this.container).hover(function() {
                    if (!instance.isPaused) instance.sliderTimeout.pause() }, function() {
            ...
            updateTimer: function(percent) { w = Math.round(percent * 100);
                if (w > 100) w = 100;
                if (w < 0) w = 0;
            ...
            playVimeoVideo: function(href, autoplay) {
                var $videoWrapper = $(".amazingslider-video-wrapper-" + this.id, this.container);
                $videoWrapper.css({ display: "block", width: "100%", height: "100%" });
                if (this.options.previewmode) { $videoWrapper.html("<div class='amazingslider-error-" + this.id + "'>To view Vimeo video, publish the slider then open it in your web browser</div>");
                    return } else {
                    ...
                    var vimeoPlayer = $f(vimeoIframe);
                    var instance = this;
                    vimeoPlayer.addEvent("ready", function() { vimeoPlayer.addEvent("finish", function(id) { instance.videoPaused = false;
                            if (!instance.isPaused) instance.slideRun(-1) }) })
                }
            },
            playIframeVideo: function(href,
                ...
                var $videoWrapper = $(".amazingslider-video-wrapper-" + this.id, this.container);
                $videoWrapper.css({ display: "block", width: "100%", height: "100%" });
                if (this.options.previewmode) { $videoWrapper.html("<div class='amazingslider-error-" + this.id + "'>To view the video, publish the slider then open it in your web browser</div>");
                    return } else {
                    var src = href;
            ...
            playYoutubeVideo: function(href, autoplay) {
                ...
                var instance = this;
                if (!ASYouTubeIframeAPIReady) { ASYouTubeTimeout += 100;
                    if (ASYouTubeTimeout < 3E3) { setTimeout(function() { instance.playYoutubeVideo(href, autoplay) }, 100);
                        return } }
                ...
                this.container.on("amazingslider.switchtext", function(event, prev, cur) {
                    ...
                    if (instance.textoptions.textstyle == "static") {
                        ...
                        switch (instance.textoptions.textpositionstatic) {
                            ...
                            case "left":
                                ...
                                break;
                            case "right":
                                $textWrapper.css({ width: instance.textoptions.textleftrightpercentforstatic + "%", height: "100%", position: "absolute", right: "0px", top: "0px", "margin": instance.textoptions.textpositionmarginstatic + "px" });
                                break;
                            case "topoutside":
                    ...
                    if (instance.textoptions.textstyle == "static") {
                        ...
                        if (instance.elemArray[cur][ELEM_DESCRIPTION].length >
                            0) $description.html(instance.elemArray[cur][ELEM_DESCRIPTION]).css({ "display": "block" });
            ...
            createStyle: function() {
                ...
                if (!this.options.isresponsive) { $(".amazingslider-space-" + this.id, this.container).css({ width: this.options.width, height: this.options.height });
                    this.container.css({ "width": this.options.width, "height": this.options.navdirection == "horizontal" && this.options.navmultirows ? "auto" : this.options.height }) } else {
                    this.resizeSlider();
                    var instance = this;
            ...
            createArrows: function() {
                ...
                if (this.options.arrowstyle == "always") { $leftArrow.css({ display: "block" });
                    ...
                    $(".amazingslider-wrapper-" + this.id, this.container).hover(function() { clearTimeout(instance.arrowTimeout);
                        if (ASPlatforms.isIE678()) { $(".amazingslider-arrow-left-" + instance.id, instance.container).show();
            ...
            createNav: function() {
                ...
                if (this.options.navstyle != "none") {
                    ...
                    if (instance.options.navthumbnavigationstyle == "auto") $nav.mousemove(function(e) {
                        ...
                        } else { $carLeftArrow.css({ left: instance.options.navthumbnavigationstyle == "arrowoutside" ? "-" + instance.options.navthumbnavigationarrowimagewidth + "px" : "0px", top: "0px", "margin-top": p + "px" });
                        ...
                        $carLeftArrow.hover(function() {
                            if (!$(this).data("disabled")) $(this).css({ "background-position": "left center" }) }, function() {
                        ...
                        if (instance.options.navthumbnavigationstyle == "arrowinside") { $carLeftArrow.hide();
                            $carRightArrow.hide();
                            $nav.hover(function() {
                                if (instance.options.navdirection == "vertical" && $bulletWrapper.height() > $navContainer.height() || instance.options.navdirection == "horizontal" && $bulletWrapper.width() > $navContainer.width()) { $carLeftArrow.fadeIn();
                                    $carRightArrow.fadeIn() } }, function() { $carLeftArrow.fadeOut();
                                $carRightArrow.fadeOut() }) }
                    }
                    if (instance.options.navdirection == "vertical") $nav.sliderTouchSwipe({
                        preventWebBrowser: true,
                        swipeTop: function(data) { instance.carMoveTop() },
                        swipeBottom: function() { instance.carMoveBottom() }
                    });
                    ...
                    this.container.on("amazingslider.switch", function(event, prev, cur) { $("#amazingslider-bullet-" + instance.id + "-" + prev, instance.container)["bulletNormal" + instance.id]();
                ...
                if (this.options.navshowbuttons) {
                    ...
                    if (this.options.navshowplaypause) {
                        ...
                        $navPlay.hover(function() {
                            if (instance.options.navbuttonhighlightcolor) $(this).css({ "background-color": instance.options.navbuttonhighlightcolor });
                            if (instance.options.navarrowimage) $(this).css({ "background-position": "left bottom" }) }, function() {
                            if (instance.options.navbuttoncolor) $(this).css({ "background-color": instance.options.navbuttoncolor });
                            if (instance.options.navarrowimage) $(this).css({ "background-position": "left top" })
                        });
                        ...
                        $navPause.hover(function() {
                            if (instance.options.navbuttonhighlightcolor) $(this).css({ "background-color": instance.options.navbuttonhighlightcolor });
                            if (instance.options.navarrowimage) $(this).css({ "background-position": "right bottom" }) }, function() {
                            if (instance.options.navbuttoncolor) $(this).css({ "background-color": instance.options.navbuttoncolor });
            ...
            createNavBullet: function(index) {
                ...
                if (this.options.navstyle == "bullets") {
                    ...
                    $.fn["bulletNormal" + this.id] = function() { $(this).css({ "background-color": instance.options.navcolor, "color": instance.options.navfontcolor });
                        if (instance.options.navbuttonshowbgimage && instance.options.navbuttonbgimage) $(this).css({ "background-position": "center top" }) };
                    $.fn["bulletHighlight" + this.id] = function() { $(this).css({ "background-color": instance.options.navhighlightcolor, "color": instance.options.navfonthighlightcolor });
                    ...
                    $.fn["bulletSelected" + this.id] = function() { $(this).css({ opacity: 1, filter: "alpha(opacity=100)" });
                        if (instance.options.navborderhighlightcolor) $(this).css({ "background-color": instance.options.navborderhighlightcolor });
                        instance.adjustNav(this) }
                }
                return $bullet
            ...
            slideRun: function(index, playVideo, transEffect) {
                ...
                if (this.options.loop > 0)
                    if (this.curElem == this.elemArray.length - 1) { this.loopCount++;
                ...
                if (this.options.versionmark != "AMC" + "om" && !(this.options.versionmark == "AML" + "ite" && this.options.skin && $.inArray(this.options.skin, ["classic", "cube", "content"]) >= 0)) {
                    ...
                    if (item.text().indexOf(this.options.watermarktext) < 0 || mklink.length < 0) {
                        ...
                        if (mklink.css("display") == "none" || mklink.css("visibility") == "hidden" || parseInt(mklink.css("font-size")) < 8 || mkdiv.css("display") == "none" || mkdiv.css("visibility") == "hidden" || parseInt(mkdiv.css("font-size")) <
                            8) { mklink.attr({ style: (mklink.attr("style") || "") + "display:block!important;visibility:visible!important;font-size:12px!important;" });
            ...
            showImage: function(slideDirection, transEffect) {
                ...
                $(imgLoader).on("load", function() {
                    ...
                    $box.amazingsliderTransition(instance.id, $imgPrev, $imgCur, {
                        ...
                        instance.sliderTimeout.resume(true) }, function(timeoutid) { instance.transitionTimeout = timeoutid;
        ...
        this.each(function() {
            ...
            var defaultOptions = {
                watermarklinkdefault: "bdkernel.com",
                ...
                threedtiles: { rowcount: 3, columncount: 5, checked: true, effects: "top,bottom,random", duration: 2E3, easing: "ease-out", depth: 20, scale: 0.8, scaleduration: 400, bgcolor: "#333333", perspective: 1E3, fallback: "tiles", scatter: 4, perspectiveorigin: "bottom" },
                tiles: {
                    rowcount: 3,
                    columncount: 5,
                    checked: true,
                ...
                kenburns: { fadeduration: 3E3, duration: 5E3, effects: "zoomin,zoomout", scale: 1.1, easing: "easeOutCubic", checked: true },
                threedhorizontal: {
                    checked: true,
                    effectdirection: 0,
                    bgcolor: "#222222",
            ...
            if (this.options.versionmark != "AMC" + "om" && !(this.options.versionmark == "AML" + "ite" && this.options.skin && $.inArray(this.options.skin, ["classic", "cube", "content"]) >= 0)) {
                ...
                this.options.watermarktext = ""; //tush
            ...
            if (typeof AMAZINGSLIDER_TEXT_EFFECT_FORMATS !== "undefined") { this.options.textformat = AMAZINGSLIDER_TEXT_EFFECT_FORMATS;
...
(function($) { $.ASUpdateObject = function(op0, op1) {
        for (var key in op0)
...
(function($) {
    $.fn.amazingsliderTransition = function(id, $prev, $next, transition, callback, transitionStartCallback) {
        ...
        if (effect == "fade") { transitionStartCallback();
            ...
            $next.show();
            if ($prev && $prev.length) $prev.fadeOut(duration, easing, function() { $prev.remove();
                callback() });
...
if (typeof amazingsliderObjects === "undefined") var amazingsliderObjects = new function() { this.objects = [];
    ...
    this.loadNext = function(id) {
        for (var i = 0; i < this.objects.length; i++)
            if (this.objects[i].id == id) { this.objects[i].videoPaused = false;
